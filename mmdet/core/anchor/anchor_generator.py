...
class AnchorGenerator(object):
    ...
    def gen_base_anchors(self):
        ...
        Returns:
            list(torch.Tensor): Base anchors of a feature grid in multiple \
                feature levels.
        MORE [tensor([[-22.6274, -11.3137,  22.6274,  11.3137],
        ...
        for i, base_size in enumerate(self.base_sizes):
            ...
            multi_level_base_anchors.append(
                self.gen_single_level_base_anchors(
                    ...
                    ratios=self.ratios,
                    center=center))
        #print("MORE", multi_level_base_anchors)
    ...
    def gen_single_level_base_anchors(self,
        ...
        BASE tensor([[-22.6274, -11.3137,  22.6274,  11.3137],
                [-16.0000, -16.0000,  16.0000,  16.0000],
                [-11.3137, -22.6274,  11.3137,  22.6274]])
        BASE tensor([[-45.2548, -22.6274,  45.2548,  22.6274],
                [-32.0000, -32.0000,  32.0000,  32.0000],
                [-22.6274, -45.2548,  22.6274,  45.2548]])
        BASE tensor([[-90.5097, -45.2548,  90.5097,  45.2548],
                [-64.0000, -64.0000,  64.0000,  64.0000],
                [-45.2548, -90.5097,  45.2548,  90.5097]])
        BASE tensor([[-181.0193,  -90.5097,  181.0193,   90.5097],
                [-128.0000, -128.0000,  128.0000,  128.0000],
                [ -90.5097, -181.0193,   90.5097,  181.0193]])
        BASE tensor([[-362.0387, -181.0193,  362.0387,  181.0193],
                [-256.0000, -256.0000,  256.0000,  256.0000],
                [-181.0193, -362.0387,  181.0193,  362.0387]])
        """
        w = base_size
