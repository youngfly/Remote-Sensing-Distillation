...
class COCOeval:
    ...
    '''
    /opt/conda/lib/python3.6/site-packages/pycocotools/
    ...
    {"supercategory": "ground track field", "id": 7, "name": "ground track field"},
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm'):
        ...
        if cocoGt is not None:
            ...
            # self.params.nameIds = sorted(cocoGt.getCatclass())
        dict_class = {'1': 'PL', '2': 'SH', '3': 'ST', '4': 'BD', '5': 'TC', '6': 'BC', '7': 'GTF', '8': 'HA', '9': 'Br', '10': 'VE'}
        # print(dict_class)
        # print(self.params.catIds)
        # print(self.params.nameIds)
    ...
    def summarize(self):
        ...
        dict_class = {'1': 'PL', '2': 'SH', '3': 'ST', '4': 'BD', '5': 'TC', '6': 'BC', '7': 'GT', '8': 'HA',
                      '9': 'Br', '10': 'VE'}
        ...
        def _summarize(ap=1, iouThr=None, areaRng='all', maxDets=100):
            ...
            # todo only to show iou=0.5 and map
            if (titleStr == 'Average Precision') & (iouStr == '0.50'):
                print(s.shape)  # todo s=[1,101,10,1]
                # print(len(s[0][0])) # todo 获取类别数
                sum = 0.0
                print("*******************")
                print("singel class ap")
                for i in range(len(s[0][0])):
                    c = s[0, :, i]
                    d = np.mean(c[c > -1])
                    print(dict_class[str(i+1)] + " : " + '%.5f' % d)
                    # print('%.f' % (i + 1) + " : " + '%.5f' % d)
                    sum = d + sum
                print("average map" + ":" + '%.5f' % (sum / 10.0))
                # print('%.5f' % (sum / 10.0))

                print("official map" + ":" + '%.5f' % (np.mean(s[s > -1])))
                # print('%.5f' % (np.mean(s[s > -1])))
                print("*******************")
